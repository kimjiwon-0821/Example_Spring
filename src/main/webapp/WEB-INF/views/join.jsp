		...
		<table>
		    ...
		    <tr>
			  ...
			  <tr>
				<th>Name</th>
		        <th>
					<input type="name" name="username" value="" placeholder="이름을 입력 하세요"/>
				</th>                
			</tr>
		   	<tr>
				<th colspan="3">
<!-- 					<div class="form-check form-check-inline">
					  <input class="form-check-input" type="radio" name="roleNum" id="inlineRadio1" value="1">
					  <label class="form-check-label" for="inlineRadio1">Admin</label>
					</div>
					<div class="form-check form-check-inline">
					  <input class="form-check-input" type="radio" name="roleNum" id="inlineRadio2" value="2">
					  <label class="form-check-label" for="inlineRadio2">Manager</label>
					</div>
					<div class="form-check form-check-inline">
					  <input class="form-check-input" type="radio" name="roleNum" id="inlineRadio3" value="3">
